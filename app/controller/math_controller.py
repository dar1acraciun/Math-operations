...
class MathController:
    ...
    def power(self,base, exponent):
        ...
        try:
            ...
            operation_model.insert_operation(self.db, self.cursor, 'power', input_data_json, formatted, user_id)
    ...
    def fibonacci(self,n):
        try:
            ...
            user_id= get_user_id_from_token()  
            operation_model.insert_operation(self.db, self.cursor, 'fibonacci', input_data_json, formatted,user_id)
    ...
    def factorial(self,n):
        try:
            ...
            input_data_json = json.dumps({'n': n})
            user_id= get_user_id_from_token()
            operation_model.insert_operation(self.db, self.cursor, 'factorial', input_data_json, formatted,user_id)
            return formatted, None
        except Exception:
